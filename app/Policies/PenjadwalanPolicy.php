...
class PenjadwalanPolicy
{
    ...
    {
        return $user->can('view_any_penjadwalan');
    ...
    {
        return $user->can('view_penjadwalan');
    ...
    {
        return $user->can('create_penjadwalan');
    ...
    {
        return $user->can('update_penjadwalan');
    ...
    {
        return $user->can('delete_penjadwalan');
